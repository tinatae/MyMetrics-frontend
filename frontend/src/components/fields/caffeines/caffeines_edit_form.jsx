...
class CaffeinesEditForm extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        this.props.fetchCaffeine(this.props.id);
    };
    ...
    changeLabel() {
        if (this.props.location.pathname === "/new_day") {
          return (<div id="update" style={{ color: `${this.props.color}` }}>{AllColoredIcons["Caffeine"]}<span>UPDATE TODAY'S CAFFEINE METRIC</span></div>)
    ...
    handleSubmit(e) {
        ...
        this.props.editCaffeine(updatedMetric)
...
export default withRouter(CaffeinesEditForm);