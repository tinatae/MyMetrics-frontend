...
class CarbsEditForm extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        this.props.fetchCarb(this.props.id);
    };
    ...
    changeLabel() {
        if (this.props.location.pathname === "/new_day") {
            return (<div id="update" style={{ color: `${this.props.color}` }}>{AllColoredIcons["Carb"]}<span>UPDATE TODAY'S CARB METRIC</span></div>)
    ...
    handleSubmit(e) {
        ...
        this.props.editCarb(updatedMetric)
...
export default withRouter(CarbsEditForm);