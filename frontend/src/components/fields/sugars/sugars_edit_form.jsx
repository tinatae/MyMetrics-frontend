...
class SugarsEditForm extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        this.props.fetchSugar(this.props.id);
    };
    ...
    changeLabel() {
        if (this.props.location.pathname === "/new_day") {
            return (<div id="update" style={{ color: `${this.props.color}` }}>{AllColoredIcons["Sugar"]}<span>UPDATE TODAY'S SUGAR METRIC</span></div>)
    ...
    handleSubmit(e) {
        ...
        this.props.editSugar(updatedMetric)
                ...
                <form onSubmit={this.handleSubmit}>
                    {this.showTitle()}
                        ...
                        <div id="add-edit-inputs">
                            ...
                            <div>
                                <select name="amt" value={this.state.amt} onChange={this.update("amt")}>
...
export default withRouter(SugarsEditForm);
