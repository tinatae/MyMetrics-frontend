...
class Vegetables extends React.Component {
        ...
        if (this.props.location.pathname === `/${FieldRoutes[category]}`) {
            return (
                <div id="field-logo">
                    ...
                    <span>Vegetables ({new Date(Date.now()).toLocaleDateString('en-US', { weekday: 'short', month: 'numeric', day: 'numeric' }).split(',').join(' ')})</span>
                </div>
            );
        } else {
            return (
    ...
    handleSubmit(e) {
        ...
        this.props.createVegetable(newVegetable)
        ...
        if (this.state.filled !== false && this.props.location.pathname === "/new_day") {
            return (
                <div id="ask-routes">
                    ...
                    &nbsp;or&nbsp;
                    <button onClick={this.exploreCategory("Vegetable")}>Explore Page</button>
                    &nbsp;or feel free to stay here & fill-out more metrics!
                </div>
            )
         } else if (this.state.filled !== false && this.props.location.pathname === "/veggies") {
            return (
                <div id="ask-routes">
                    Metric has been successfully created! Check it out on your&nbsp;
                    <button onClick={this.goToProfile(user)}>Profile</button>     
    ...
    render() {
        ...
        return (
            <div className="vegetable field-add" style={{backgroundColor: FieldColors["Vegetable"]}}>
                <form onSubmit={this.handleSubmit}>
                    <div className="form">
                        ...
                        <div id="add-inputs">
                            ...
                            <div>
                                <select name="Veggies" value={amt} onChange={this.update("amt")}>
